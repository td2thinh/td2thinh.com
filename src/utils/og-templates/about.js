...
export default async () => {
    return satori(
                    ...
                    },
                    {
                        ...
                        props: {
                            ...
                            children: [
                                ...
                                {
                                    type: "div", // Use a div as a container
                                    props: {
                                        style: {
                                            display: "flex",
                                        ...
                                        children: [
                                            ...
                                            },
                                            {
                                                type: "span",
                                                props: {
                                                    // You can add a little top margin for spacing if you like
                                                    // style: { marginTop: '8px' }, 
                                                    children: SITE.desc,
                                                },
                                            },
        ...
        },
        {
            ...
            height: 640,
            embedFont: true,
            // Emojis are now images, so we don't need to load font characters for them
            fonts: await loadFonts("About Discover" + SITE.title + SITE.desc + SITE.website),
        }
    );
};